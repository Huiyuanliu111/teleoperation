...
RowVectorXf savgolfilt(VectorXf const &x, int k, int F)
{
  ...
  auto n = Bbutt.rows();
  //flip Bbutt from to the way down
  ...
  // *****************************************************************
  // changed type from auto to float, then it returns correct value
  // *****************************************************************
  float y_ss = Bzerothf.transpose().eval() * x; //This is the steady-state smoothed value 
  ...
  // *****************************************************************
  // changed the order of output, the transient off value should be the last ones
  // *****************************************************************
  // y << y_off.transpose().eval(), y_ss, y_on.transpose().eval();
  y << y_on.transpose().eval(), y_ss, y_off.transpose().eval();
