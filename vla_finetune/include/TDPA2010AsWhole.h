...
public:
	...
	void energyController(double target[DoF], double ref[DoF], double E_F_in_delayed, double deltaT);
...
public:
	...
	void energyObserver(double v[DoF], double f[DoF], double deltaT);
	void energyController(double target[DoF], double ref[DoF], double E_L_in_delayed, double deltaT);
